  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      ...
      compileSync: function(sourcePath, source) {
        ...
        libs.stylus(source, options).use(libs.bootstrap()).use(libs.nib()).use(libs.fluidity()).use(libs.bootstrap()).set('compress', this.compress).set('include css', true).render(callback);
        return result;
      }
    },
    less: {
