(function() {
  ...
  updateDependenciesSync = function(filePath, options) {
    var c, depPath, directive, directivePath, ext, jsCompilerExts, jsExtList, oldTime, requireTree, words, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4;
    ...
    if ((_ref2 = dependencies[filePath]) == null) dependencies[filePath] = [];
      ...
      switch (words[0]) {
        ...
        case 'require_tree':
          requireTree = function(parentDir, paths) {
            var p, stats, _k, _len3, _ref5, _results;
            _results = [];
            for (_k = 0, _len3 = paths.length; _k < _len3; _k++) {
              ...
              stats = fs.statSync(p);
              if (stats.isFile()) {
                if (_ref5 = path.extname(p), __indexOf.call(jsExtList, _ref5) < 0) {
                  continue;
                }
