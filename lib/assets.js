(function() {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.compileCSS = function(route) {
      var buildPath, cacheFlags, css, ext, filename, mtime, source, sourcePath, stats, _i, _len, _ref, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          ...
          if (ext === 'css') {
            ...
            if (css === ((_ref3 = this.compiledCss[sourcePath]) != null ? _ref3.toString('utf8') : void 0)) {
