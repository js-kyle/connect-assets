...
(function() {
  ...
  module.exports = exports = function(options) {
    var connectAssets, _base, _base1, _base2, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    if (connectAssets) {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      if ((_ref5 = (_base2 = cssCompilers.less).yuicompress) == null) {
        _base2.yuicompress = true;
      }
    }
  ...
  exports.cssCompilers = cssCompilers = {
    ...
    less: {
      ...
      compileSync: function(sourcePath, source) {
        var callback, compress, options, result, yuicompress, _ref, _ref1;
        result = "";
        ...
        yuicompress = (_ref1 = this.yuicompress) != null ? _ref1 : false;
