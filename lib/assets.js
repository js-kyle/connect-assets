...
(function() {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.createHelpers = function() {
      ...
      context._js = function(route, routeOptions) {
        var attrs, p, routes;
        ...
        attrs = _this.options.pathsOnly ? [] : parseAttributes(routeOptions);
        return [routes, attrs];
      };
      context.js = function(route, routeOptions) {
        var attrs, r, routes, scripts, _i, _len, _ref;
        if (routeOptions == null) {
          routeOptions = {};
        }
        _ref = context._js(route, routeOptions), routes = _ref[0], attrs = _ref[1];
        scripts = [];
      ...
      context.js.root = 'js';
      context.sub = function(route, routeOptions) {
        var attrs, r, routes, scripts, _i, _len, _ref;
        if (routeOptions == null) {
          routeOptions = {};
        }
