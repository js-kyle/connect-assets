(function() {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.compileCSS = function(route) {
      var alreadyCached, buildPath, cacheFlags, css, data, ext, filename, mtime, source, sourcePath, stats, _i, _len, _ref, _ref2, _ref3, _ref4;
    ...
    ConnectAssets.prototype.compileJS = function(route) {
      var callback, chain, ext, filename, filenames, js, snocketsFlags, sourcePath, _i, _len, _ref;
