...
(function() {
  var BEFORE_DOT, ConnectAssets, EXPLICIT_PATH, REMOTE_PATH, Snockets, connectCache, crypto, cssCompilers, cssExts, exports, extend, fs, getExt, jsCompilers, libs, md5Filenamer, mkdirRecursive, parse, path, stripExt, timeEq, zlib,
    __slice = [].slice;
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.cacheImg = function(route) {
      var alreadyCached, cacheFlags, filename, img, mtime, sourcePath, stats, _ref;
    ...
    ConnectAssets.prototype.compileCSS = function(route) {
      var alreadyCached, cacheFlags, css, data, ext, filename, mtime, source, sourcePath, startTime, stats, _i, _len, _ref, _ref1, _ref2, _ref3;
      if (!this.options.detectChanges && this.cachedRoutePaths[route]) {
        return this.cachedRoutePaths[route];
      }
          ...
          if (this.options.build) {
            ...
            callback = function(err, concatenation, changed) {
              ...
              if (changed) {
                ...
                return _this.writeFile(filename, concatenation);
              } else {
    ...
    ConnectAssets.prototype.writeFile = function(filename, content) {
      var buildPath,
        _this = this;
      if (this.options.buildDir) {
        ...
        return mkdirRecursive(path.dirname(buildPath), 0x1ed, function(err) {
          ...
          if (_this.options.gzip && !(content.length < _this.options.gzipThreshold)) {
            zlib.gzip(content, function(_, buf) {
              return fs.writeFile(buildPath + ".gz", buf);
            });
          }
        });
      }
