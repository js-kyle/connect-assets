(function() {
  var BEFORE_DOT, ConnectAssets, EXPLICIT_PATH, REMOTE_PATH, Snockets, connectAssets, connectCache, crypto, cssCompilers, cssExts, fs, jsCompilers, libs, md5Filenamer, mkdirRecursive, normalizeRoute, parse, path, stripExt, stripMd5Hash, timeEq, _;
  ...
  module.exports = function(options) {
    ...
    return connectAssets.middleware;
  };
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.middleware = function(req, res, next) {
      var route;
      if (req.method !== 'GET') {
        return next();
      }
      route = stripMd5Hash(parse(req.url).pathname);
      return this.cache.loadFile(route, __bind(function() {
        if (this.cache.map[route]) {
          return this.cache.serveBuffer(req, res, next, {
            route: route
          });
        } else {
          return next();
    ...
    ConnectAssets.prototype.compileJS = function(route) {
      var buildPath, cacheFlags, chain, concatenation, ext, filename, filenames, js, snocketsFlags, sourcePath, _i, _len, _ref, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          if (this.options.build) {
            filename = (_ref2 = this.cache.map[normalizeRoute(route)]) != null ? (_ref3 = _ref2.flags) != null ? _ref3.md5Filename : void 0 : void 0;
            if (!filename) {
              snocketsFlags = {
              ...
              this.cache.set(route, concatenation, cacheFlags);
              if (this.options.buildDir) {
                buildPath = path.join(process.cwd(), this.options.buildDir, filename);
            ...
            return filenames = (function() {
              ...
              for (_j = 0, _len2 = chain.length; _j < _len2; _j++) {
                _ref4 = chain[_j], filename = _ref4.filename, js = _ref4.js;
  ...
  stripMd5Hash = function(filename) {
