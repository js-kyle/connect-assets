  ...
  module.exports.compilers = compilers = {
    ...
    styl: {
      ...
      compileStr: function(styl, filePath) {
        ...
        libs.stylus(styl).set('filename', filePath).set('compress', compilers.styl.compress).use(libs.nib()).render(callback);
        return result;
      }
    }
  };
