(function() {
  var BEFORE_DOT, ConnectAssets, EXPLICIT_PATH, REMOTE_PATH, Snockets, connectCache, crypto, cssCompilers, cssExts, exports, fs, jsCompilers, libs, md5Filenamer, mkdirRecursive, parse, path, stripExt, timeEq, _;
  ...
  module.exports = exports = function(options) {
    ...
    if ((_ref5 = options.buildDir) == null) options.buildDir = 'builtAssets';
    if ((_ref6 = options.buildFilenamer) == null) {
      options.buildFilenamer = md5Filenamer;
    }
    if ((_ref7 = options.buildsExpire) == null) options.buildsExpire = false;
    if ((_ref8 = options.detectChanges) == null) options.detectChanges = true;
    if ((_ref9 = options.minifyBuilds) == null) options.minifyBuilds = true;
